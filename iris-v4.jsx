...
function getFacetInterpretation(f, v) { return v <= 0.35 ? f.low : v <= 0.65 ? f.mid : f.high; }
...
export default function IRISApp() {
  const [phase, setPhase] = useState("landing"); // landing|coliseum|assess|results
    ...
    return (<div style={{ ...wrap }}>{fonts}
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column", pointerEvents: "none" }}>
        ...
        <div style={{ background: "linear-gradient(transparent,rgba(6,6,14,.85) 30%,rgba(6,6,14,.95))", padding: "36px 18px 20px", pointerEvents: "auto" }}>
          ...
          <div style={{ textAlign: "center", marginTop: 8 }}><button onClick={restart} style={{ background: "transparent", border: "none", color: "#333", fontSize: 9, cursor: "pointer", ...m, letterSpacing: 2, textTransform: "uppercase" }}>Re-Simulate</button></div>
