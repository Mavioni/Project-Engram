...
`@react-three/drei@10.7.7`, `@react-three/fiber@9.6.0`, `@react-three/postprocessing@3.0.4`, `@supabase/supabase-js@2.104.0`, `@wllama/wllama@3.5.1`, `date-fns@4.1.0`, `dexie@4.0.8`, `react@19.2.5`, `react-dom@19.2.5`, `react-router-dom@7.14.1`, `recharts@3.8.1`, `three@0.184.0`, `zustand@5.0.12`
